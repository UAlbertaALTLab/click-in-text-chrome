...
function save_options() {
  ...
  Options.target_lang($('#target_lang').val()) // todo: remove this
  Options.from_lang($('#from_lang').val()) // todo: remove this
  Options.reverse_lang($('#reverse_lang').val()) // todo: remove this
  ...
  Options.tts($('#tts:checked').val() ? 1 : 0) // todo: remove this
  Options.tts_key($('#tts_key').val()) // todo: remove this
  ...
  Options.show_from_lang($('#show_from_lang:checked').val() ? 1 : 0) // todo: remove this
