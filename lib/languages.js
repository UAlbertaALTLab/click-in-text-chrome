// the popup displays language source as whatever 'label' value is.
// todo: remove this file, language source doesn't needs to get displayed as we only need to translate from cree to English
export default {
  'cree': {label: 'Cree', direction:'ltr'},
